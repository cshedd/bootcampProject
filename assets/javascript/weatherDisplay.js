$(document).ready(function(event) {
  ...
  //     $('.weatherDisplay').append("<div><p class='weatherCityName'>" + response.name + "</p><p class='weatherDescription'>" + response.weather[0].description + "</p><p class='temperature'>" + response.main.temp + "\u2109" + "</p></div>");
  // });
  $.ajax({url: queryURL, method: 'GET'})
    .done(function(response) {
      console.log(response);
